...
public:
   ...
   */
  inline MadGraphTwoCut(CutType t, PPType p, double c);

  /**
   * The copy constructor.
   */
  inline MadGraphTwoCut(const MadGraphTwoCut &);

  /**
   * The destructor.
   */
  virtual ~MadGraphTwoCut();
  //@}
