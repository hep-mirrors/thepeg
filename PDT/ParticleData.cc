...
void ParticleData::Init() {
  ...
  static Parameter<ParticleData,Energy> interfaceMass
    ("NominalMass",
     ...
     "<code>Mass_generator</code> object associated with the "
     "particle.",
  ...
  static Parameter<ParticleData,Length> interfaceCTau
    ("LifeTime",
     ...
     "from this number by the <code>Mass_generator</code> "
  ...
  static Parameter<ParticleData, int> interfaceCharge
    ("Charge",
     ...
     "See also the command interface <code>SetCharge</code>.",
