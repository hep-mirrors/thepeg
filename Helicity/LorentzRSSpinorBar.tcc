...
template<typename Value> LorentzRSSpinor<Value> LorentzRSSpinorBar<Value>::bar()
{
...
template<typename Value> LorentzRSSpinorBar<Value> & LorentzRSSpinorBar<Value>::boost(double bx,double by,double bz)
{
...
template<typename Value> LorentzRSSpinorBar<Value> & LorentzRSSpinorBar<Value>::boost(const Boost & boostvec)
{
...
template<typename Value> LorentzRSSpinorBar<Value> & LorentzRSSpinorBar<Value>::transform(const LorentzRotation & r)
{
  ...
  if(Rep()==defaultDRep)
    ...
    {
      LorentzRSSpinorBar<Value> temp((*this).transformRep(defaultDRep));
      for(ix=0;ix<4;++ix)
	{
	  for(iy=0;iy<4;++iy)
	    {
